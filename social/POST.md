...
>
> QuantSafe Router scores a (model, quant) config using the Refusal Stability Screen and tells you whether to deploy or fall back to a safe baseline.
>
...
>
> That's what the Refusal Stability Screen buys you: a four-feature behavioral screen that flags quantization cells where retained quality masks safety degradation.
>
...
>
> QuantSafe Router is a Gradio app that scores any (model, quantization) config using the Refusal Stability Screen — a four-feature behavioral screen that produces a refusal-drift score. Features derived entirely from refusal-output behavior — no ground-truth labels needed at scoring time:
>
...
> - The highest refusal-drift score: qwen2.5-1.5b + GPTQ at 0.79
>
